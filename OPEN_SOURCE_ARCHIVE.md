...
*Added after the freeze. The text above is unchanged.*

- The "+$8,471" pre-launch paper P&L is rounded. The source output
  (`docs/backtest_results_2026-04-01.txt`) reports **$8,470.70**.
- Lesson 5 reads "bots with NWS PRIVATE_KEY direct feeds". That is a garbled
  edit; it should read "bots with direct NWS feeds". No private key is involved.
