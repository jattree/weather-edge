...
Inspired by [@TopTrader's Claude Trader](https://polymarket.com/profile/@TopTrader) ($76K positions, 4,307 predictions, 73% win rate).
...
7. Runs dual strategy: 70% core bets + 30% TopTrader-style penny tail bets
